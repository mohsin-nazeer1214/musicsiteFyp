...
{  
   ...
   $filename = $_FILES["uploadfile"]["name"];
    ...
    $folder = "artisimage/".$filename;
   
     $sql = "INSERT INTO artists (artist_name,artist_bio,filename)
   VALUES ('$artist_name','$artist_bio','$filename')";
  
   $check=mysqli_query($conn,$sql);
   if(move_uploaded_file($tempname,$folder)){
    
 header("location:artist_data.php");
      }
   else{
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Add Music Artist</h4>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input
                          type="text"
                          class="form-control"
                          id="fname" required="" name="artist_name"
                      ...
                      <br>
                        ...
                        for="fname"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Enter Artist Bio</label
                      >
                       <div class="col-sm-9">
                        <input
                          type="text"
                          class="form-control"
                          id="fname" required=""  name="artist_bio"
                      ...
                      >
                        ...
                        <input
                          type="file"
                          class="form-control"
                          id="fname" required=""  name="uploadfile"
                          placeholder="Enter Artist Bio"
                        />
                      </div>
                    </div>
