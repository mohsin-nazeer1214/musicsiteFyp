...
$conn = new mysqli("localhost", "root", "", "music_world");
  ...
  $category_id = $_POST['category_id'];
   ...
   $filename = $_FILES["uploadfile"]["name"];
    ...
    $folder = "music/" . $filename;
    move_uploaded_file($tempname,$folder);
   
    $filenam = $_FILES["uploadfil"]["name"];
    $tempnam = $_FILES["uploadfil"]["tmp_name"];
    $folde = "image/" . $filenam;
    move_uploaded_file($tempnam,$folde);
    //echo "folde :".$folde;die();

     $sql = "INSERT INTO musics (category_id,music_title,music_genre,filename,filenam)
   VALUES ('$category_id','$music_title','$music_genre','$filename','$filenam')";
   $check=mysqli_query($conn,$sql);
   if($sql){
    
header("location:music_Data.php");
      }
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Add Music </h4>
...
<?php  } ?>
                      ...
                      <div class="col-sm-9">
                        <input
                          type="text"
                          class="form-control"
                          id="fname" required="" name="music_title"
                      ...
                      <br>
                        ...
                        for="fname"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Enter Music Genre</label
                      >
                       <div class="col-sm-9">
                        <input
                          type="text"
                          class="form-control"
                          id="fname" name="music_genre"
                      ...
                      <br>
                        ...
                        for="fname"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Upload Music Fie</label
                      >
                        <div class="col-sm-9">
                        <input
                          type="file"
                          class="form-control"
                          id="fname" name="uploadfile"
