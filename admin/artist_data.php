        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Music Artist Data</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
             ...
             <button type="button" class="btn btn-dark">Add Artist</button></a>
                          ...
                          <td><?php echo $row['artist_id']?></td>
                           <td><?php echo $row['artist_name']?></td>
                              <td><?php echo $row['artist_bio']?></td>
                               <td><img src="artisimage/<?php echo $row['filename'] ?>" width="70px"></td>
