...
<!-- <a href="admin/music/<?php echo $row['filename']?>" class="btn btn-outline-primary btn-sm">Download</a> -->
                                                    </div>
           
                                                    -
                                                  <td><img src="admin/image/<?php echo $row['filenam'] ?>" width="230px"  height="270px"></td>
