...
$query = "SELECT * FROM user_playlist WHERE user_id = $id";
                        ...
                        <div class="music_field">
                            ...
                            <div class="audio_name">
                                <div class="name">
                                    ...
                                    <p><?php echo $row['music_description']?></p>
                                    <td><video width="320" height="240" controls>
                                      <source src="user_music/<?php echo $row['filename']?>" type="video/ogg" height="20px" width="20px">
                                    </video></td>
                                </div>
                            </div>
                        </div>
